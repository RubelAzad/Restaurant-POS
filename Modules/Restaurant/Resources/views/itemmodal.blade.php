                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <x-form.selectbox labelName="Category" name="rcat_id" required="required" col="col-md-4"
                                ...
                                <option value="{{ $catgory->p_id }}"> {{ $catgory->p_name }}</option>
                            ...
                            <x-form.textbox labelName="Tax" name="tax" col="col-md-4"
                            placeholder="0.00" />
                            <x-form.textbox labelName="Price" name="price" required="required" col="col-md-4"
                                placeholder="0.00" />

                            <x-form.textbox labelName="Quantity" name="qty" col="col-md-4"
                                placeholder="0.00" />
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-check-input" type="checkbox" name="offer" id="offer" value="offer">
                                    <label class="form-check-label"  for="offer">Offer</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group col-md-6">
                                <input class="form-check-input" type="checkbox" name="special" id="special" value="special">
                                    <label class="form-check-label" for="inlineCheckbox1">Special</label>
                                </div>
                            </div>
                            <x-form.textbox labelName="Cooking Time" name="oc_time" required="required" col="col-md-4" class="time"/>
                                
                            <x-form.textbox labelName="Offer Price" name="op_rate" col="col-md-4 dependentOnOffer" placeholder="0.00" />
                            <x-form.textbox labelName="Offer Start Date" name="os_date" col="col-md-4 dependentOnOffer" class="date"/>
                            <x-form.textbox labelName="Offer End Date" name="oe_date" col="col-md-4 dependentOnOffer" class="date"/>
                                        ...
                                        <div class="ant-checkbox-group" id="ri_menu">
                                            <label class="ant-checkbox-wrapper ant-checkbox-group-item">
                                                <span class="ant-checkbox">
                                                    <input type="checkbox" name="ri_menu[]" class="ant-checkbox-input" value="Launch">
                                            ...
                                            <label class="ant-checkbox-wrapper ant-checkbox-group-item">
                                                <span class="ant-checkbox">
                                                    <input type="checkbox" name="ri_menu[]" class="ant-checkbox-input" value="Party">
                                                    <span class="ant-checkbox-inner"></span>
                                                </span><span>Party</span>
                                            </label>
                                            <label class="ant-checkbox-wrapper ant-checkbox-group-item">
                                                <span class="ant-checkbox">
                                                    <input type="checkbox" name="ri_menu[]" class="ant-checkbox-input" value="Coffee">
                                                    <span class="ant-checkbox-inner"></span>
                                                </span>
                                                <span>Coffee</span>
                                            </label>
                                            <label class="ant-checkbox-wrapper ant-checkbox-group-item">
                                                <span class="ant-checkbox">
                                                    <input type="checkbox" name="ri_menu[]" class="ant-checkbox-input" value="Breakfast">
                                                    <span class="ant-checkbox-inner"></span>
                                                </span>
                                                <span>Breakfast</span>
                                            </label>
                                            <label class="ant-checkbox-wrapper ant-checkbox-group-item">
                                                <span class="ant-checkbox">
                                                    <input type="checkbox" name="ri_menu[]" class="ant-checkbox-input" value="Dinner">
                                                    <span class="ant-checkbox-inner"></span>
                                                </span>
                                                <span>Dinner</span>
                                            </label>
