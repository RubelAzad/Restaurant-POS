    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('rtable-add'))
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Table','Save')">
                ...
                <div class="dt-card__body">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="capacity">Capacity No.</label>
                                <input type="text" class="form-control" name="capacity" id="capacity" placeholder="Enter capacity">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="floor_id">floor</label>
                                <select name="floor_id" id="floor_id" class="form-control selectpicker" data-live-search="true" 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('rtable.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('rtable.store.or.update')}}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('rtable.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        // let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('rtable.change.status') }}";
