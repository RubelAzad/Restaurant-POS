    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('ritem-add'))
                <button class="btn btn-primary btn-sm" onclick="showStoreFormModal('Add New ritem','Save')">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Food name">
                            </div>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('ritem.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('ritem.store.or.update')}}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #rcat_id').val(data.rcat_id);
                    $('#store_or_update_form #components').val(data.components);
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('ritem.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('ritem.change.status') }}";
