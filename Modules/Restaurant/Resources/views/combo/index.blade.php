...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="dt-entry__header">
                    ...
                    <!-- /entry heading -->
                    @if (permission('fcpackage-add'))
                        <button class="btn btn-primary btn-sm"
                            onclick="showStoreFormModal('Add New Food Combo Package','Save')">
    ...
    @include('restaurant::combo.modal')
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('fcpackage.datatable.data') }}",
                    "type": "POST",
                    "data": function(data) {
                ...
                "buttons": [
                    @if (permission('fcpackage-report'))
                        {
                            'extend': 'colvis',
            ...
            $(document).on('click', '#save-btn', function() {
                ...
                let url = "{{ route('fcpackage.store.or.update') }}";
                ...
                if (id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#store_or_update_form #event_type').val(data.event_type);
                            $('#store_or_update_form #price').val(data.price);

                            let foodComboMenuArray = data.item_name.split(',');

                            $('#multi option').each(function() {
                                if (foodComboMenuArray.includes($(this).val())) {
                            ...
                            // let foodComboInputs = $('.foodComboInputs option[value=""]');
                            // foodComboInputs.each(function(){
                            //     if(foodComboMenuArray.includes($(this).val())){
                            ...
                            if (data.image) {
                                var image = "{{ asset('storage/' . ITEM_COMBO_IMAGE_PATH) }}/" +
                                    data.image;
            ...
            $(document).on('click', '.delete_data', function() {
                ...
                let url = "{{ route('fcpackage.delete') }}";
            ...
            function multi_delete() {
                ...
                if (ids.length == 0) {
                    ...
                    let url = "{{ route('fcpackage.bulk.delete') }}";
            ...
            $(document).on('click', '.change_status', function() {
                ...
                let name = $(this).data('name');
                let row = table.row($(this).parent('tr'));
                let url = "{{ route('fcpackage.change.status') }}";
