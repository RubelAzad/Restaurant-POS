        ...
        if(permission('rvariant-access')){
            if($request->ajax()){
                if (!empty($request->item_id)) {
                    $this->model->setItem($request->item_id);
                }
                ...
                foreach ($list as $value) {
                    ...
                    $row[] = $value->price;
                    $row[] = permission('rvariant-edit') ? change_status($value->id,$value->status,$value->name) : STATUS_LABEL[$value->status];;
