            ...
            <div class="col-xl-12">
                ...
                <div class="dt-entry__header">
                    ...
                    @if (permission('card-add'))
                        <button class="btn btn-primary btn-sm" onclick="showStoreFormModal('Add New card','Save')">
                        ...
                        <table id="dataTable" class="table table-striped table-bordered table-hover">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th>Card Number</th>
                                    <th>Member Name</th>
                                    <th>Card Minmum Value</th>
                                    <th>Trash Hold Value</th>
                                    <th>Room Access</th>
                ...
                if (id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#store_or_update_form #card_type').val(data.card_type);
                            $('#store_or_update_form #card_member_id').val(data.card_member_id);
                            $('#store_or_update_form #card_min_value').val(data.card_min_value);
                            $('#store_or_update_form #card_trash_hold').val(data
                                .card_trash_hold);
                            $('#store_or_update_form #room_access').val(data.room_access);
                            //$('#store_or_update_form #card_facilities_id').val(data.card_facilities_id);
                            //$('#store_or_update_form #ri_menu').val(data.ri_menu);


                            let riMenuArray = data.card_facilities_id.split(',');
                            ...
                            if (data.image) {
                                var image = "{{ asset('storage/' . CARD_IMAGE_PATH) }}/" + data
                                    .image;
